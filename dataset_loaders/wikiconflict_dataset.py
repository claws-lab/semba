...
class tgn_wikiconflict(InMemoryDataset):
    ...
    def __init__(self, root: str, edge_window_size: int = 10,
        ...
        self.name = name
        if self.name == 'wikiconflict':
            self.url = 'http://konect.cc/files/download.tsv.wikiconflict.tar.bz2'
    ...
    def raw_file_names(self) -> str:
        if self.name == 'wikiconflict':
            return 'wikiconflict/out.wikiconflict'
